...
for epoch in range(50):  # loop over the dataset multiple times
    ...
    for i, data in enumerate(data_train):
        ...
        #print('Here labels shape ::', labels.shape)
        ...
        #print('output1::', output1.hhape
        #print('output2::', output2)
        #print('outputs type', outputs.dtype)
        #print('la:', labels)
        #print(outputs)
        #print('selected labels1::', labels[:,0])
        #print('selected labels2::', labels[:,1:])
        ...
        if i % 2000  == 1999:
            ...
            for ix, datax in enumerate(data_valid):
                ...
                #print('tsetselected labels1::', labels[:,0])
                #print('tstselected labels2::', labels[:,1:])
